  ...
  */
  ...
  useEffect(() => {
    if (grupo) {
      ...
      fetch(
        `${backendUrl}/oracle/estudiantes/buscar-por-codigo?codigo=${grupo.codCarrera}`
      )
        .then((response) => response.json())
        .then((data) => {
      ...
      fetch(
        `${backendUrl}/oracle/materias-matriculadas/filtrar?codCarMat=${grupo.codCarrera}&codMatMat=${grupo.codMateria}&grupo=${grupo.grupo}`
      )
        .then((response) => response.json())
        .then((data) => {
          setMatriculas(data)
