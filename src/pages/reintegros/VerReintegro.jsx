  ...
  const fetchReintegroData = () => {
    ...
    fetch(`${backendUrl}/solicitudes/solicitud/${id}`)
      ...
      .catch((err) => {
        ...
        setLoading(false)
        showAlerta(
          'No se pudo cargar la información del reintegro',
          'error',
          'Error de conexión'
        )
      })
  ...
  const handleApproveReintegro = async () => {
    ...
    try {
      const response = await fetch(
        `${backendUrl}/solicitudes/reintegro/aprobar/${id}`,
        {
          method: 'POST',
          body: formData,
          headers: {
      ...
      showAlerta(
        data.mensaje || 'Reintegro aprobado con éxito',
        'success',
        'Solicitud aprobada'
      )
    } catch (err) {
  ...
  if (error) {
    return (
      <div className='flex flex-col items-center justify-center h-screen'>
        ...
        <Boton
          onClick={() => navigate('/matricula/reintegros')}
    ...
    <div className='flex flex-col w-full items-center p-4'>
      <div className='w-full flex flex-row justify-between mb-6'>
        ...
        <p className='text-center text-titulos'>
          Detalles de la Solicitud de Reintegro
        </p>
        ...
        cuerpo={
          <div>
            ...
            <p className='mt-2 mb-1'>
              Esta acción aprobará el reintegro, habilitará al estudiante para
              matricular materias y cambiará el estado del estudiante a En
              curso.
            </p>
