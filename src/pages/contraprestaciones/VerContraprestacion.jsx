...
const VerContraprestacion = () => {
  ...
  const handleGenerateCertificate = async () => {
    if (!contraprestacion.aprobada) {
      showAlerta(
        'La contraprestación debe estar aprobada para generar el certificado',
        'error',
  ...
  if (error) {
    return (
      <div className='flex flex-col items-center justify-center h-screen'>
        ...
        <Boton
          onClick={() => navigate('/matricula/contraprestaciones')}
      ...
      <div className='w-full flex flex-col'>
        ...
        <div className='w-full flex flex-row'>
          <Input
            ...
            type='text'
            value={
              contraprestacion.aprobada ? 'Aprobada' : 'Pendiente de aprobación'
            }
          />
          <Input />
        </div>
      ...
      <div className='w-full'>
        <div className='w-full px-4'>
          <textarea
            ...
            readOnly
            value={
              contraprestacion.actividades || 'No se han registrado actividades'
            }
          />
        </div>
      </div>
              ...
              <div className='flex-grow'>
                <div className='flex items-center'>
                  ...
                  <p className='font-medium'>
                    {contraprestacion.soporte.nombre_archivo}
                  </p>
                </div>
                <p className='text-sm text-gray-500 mt-1'>
                  Tipo: {contraprestacion.soporte.mime_type} | Tamaño:{' '}
                  {contraprestacion.soporte.peso}
                </p>
                <p className='text-sm text-gray-500'>
                  Subido el {formatDate(contraprestacion.soporte.fecha_subida)}
                </p>
              </div>
              <div>
                <Boton
        ...
        cuerpo={
          <div>
            ...
            <p>
              ...
              {contraprestacion.primerNombre} {contraprestacion.primerApellido}{' '}
              realizada en el semestre {contraprestacion.semestre}?
            </p>

            <p className='text-normal mt-6 mb-2'>
              Informe de Contraprestación (PDF)
            </p>
            <Divider className='mb-4' />
