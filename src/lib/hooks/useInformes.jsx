import { crearColoquio, editarColoquio, eliminarInforme, eliminarInformeArchivo, entregarInforme, listarDocumentosDeEntregaColoquio, listarEntregasColoquio, listarGruposDocente, listarInformesDocente, obtenerEntregaInformes, obtenerInformes } from "../controllers/informes/actions"
...
export default function useInformes() {
   ...
   const deleteInforme = async (idInforme) => {
      try {
         await eliminarInforme({ informeId: idInforme, googleToken: googleToken })
         return true
      } catch (error) {
   ...
   return { getInformes, deleteInforme, listEntregasColoquio, listDocumentosEntregasColoquio, editColoquio, sendInforme, getEntregaInformes, deleteInformeArchivo, listGruposDocente, listInformesDocente, createColoquio }
}